function [BS] = ridgeAll_nonnorm(Xall,yall,figname,outfolder)
...
% 1. Run ridge
for is=1:numel(Xall)
   [DS(is,:),bs(is,:,:),lspace]  = ridgeSub_nonnorm(yall{is},Xall{is});                     % DS is deviance for self condition, nSub x nLambda 
end

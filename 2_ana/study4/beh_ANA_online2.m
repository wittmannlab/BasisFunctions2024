...
%%------------------------------
doexport = 1;
beh_showSch_online2(s.beh,doexport,outfolder)               % for figs6 output PosFrequency         plotted via plot_online2.R
beh_posRating(s.beh,doexport,outfolder)                     % for figs6 output PosRating            plotted via plot_online2.R
beh_glmpos(s.beh,doexport,outfolder);                       % for figs6 output GLMpos               plotted via plot_online2.R

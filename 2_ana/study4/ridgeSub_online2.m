function [D,B,lspace,kfold,ncv] = ridgeSub_online2(y,X,lam)
...
lspace   = [0 logspace(-3,0,15)];                                            % logspace(a,b,n)  generates n points between decades 10^a and 10^b.
...
for icv = 1:ncv
   [bs,Fitinfo]   = lassoglm(zscore(X),y,'binomial','Alpha',alpha,'Lambda',lspace,'CV',kfold);

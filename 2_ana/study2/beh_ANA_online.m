...
%%------------------------------
doexport = 1; 
beh_showSch(s.beh,doexport,outfolderfigs)           % for fig.4C, ExtData_Fig8ab, prints figure directly:sch_illustration_detailed, sch_illustration_summary     
beh_desc(s.beh,doexport,outfolder);                 % for fig4DE, ExtData_Fig8cd  output: Desc_pcorr

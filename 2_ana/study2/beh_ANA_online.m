...
%%------------------------------
doexport = 1; 
beh_showSch(s.beh,doexport,outfolderfigs)           % for fig.4C,S19, prints figure directly:sch_illustration_detailed, sch_illustration_summary     
beh_desc(s.beh,doexport,outfolder);                 % for fig4DE, FigS20     output: Desc_pcorr
